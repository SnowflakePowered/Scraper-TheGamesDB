    ...
    public class ApiGame {
        ...
        public class ApiGameImages {
            ...
            public ApiGameImages() {
                Fanart = new List<ApiGameImage>();
                Banners = new List<ApiGameImage>();
                Screenshots = new List<ApiGameImage>();
            }
            ...
            public void FromXmlNode(XmlNode node) {
                ...
                while (ienumImages.MoveNext()) {
                    ...
                    switch (imageNode.Name) {
                        case "fanart":
                            Fanart.Add(new ApiGameImage(imageNode.FirstChild));
                            break;
                        case "banner":
                            Banners.Add(new ApiGameImage(imageNode));
                            break;
                        case "screenshot":
                            Screenshots.Add(new ApiGameImage(imageNode.FirstChild));
                            break;
                        case "boxart":
                            if (imageNode.Attributes.GetNamedItem("side").InnerText == "front") {
                                BoxartFront = new ApiGameImage(imageNode);
                            }
                            else {
                                BoxartBack = new ApiGameImage(imageNode);
                            }
